...
<div class="container mt-5">
    ...
    <div class="jumbotron text-center">
        ...
        <p class="lead">Gerencie seus projetos de maneira fácil e eficiente com a nossa plataforma.</p>
        <hr class="my-4">
        <p>Veja o que você pode fazer:</p>
        <ul class="list-unstyled">
            <li><i class="bi bi-check-circle-fill text-success"></i> Crie e atribua tarefas</li>
            <li><i class="bi bi-check-circle-fill text-success"></i> Acompanhe o progresso dos projetos</li>
            <li><i class="bi bi-check-circle-fill text-success"></i> Comunique-se com sua equipe</li>
            <li><i class="bi bi-check-circle-fill text-success"></i> Gere relatórios e análises</li>
        </ul>
